{ 
    # Whether to print debugging information when running flake commands.
    # This is not too noisy and should be set to true.
    debug = true;
    ...
    #   outputs.packages.x86_64-linux.__foo__.bar
    # A value of "" means: do not nest.
    flakeOutputsPrefix = "";

    # The directory containing the cabal.project file. 
    # TODO use inputs.self instead 
    # TODO rename to cabalProjectDir
    repoRoot = ./.;
